...
class CameraParams:
    ...
    def saveParamsAsMat(self, fileName, rotationalVector=None, translationVector=None, dict=None):
        dictionary = self.toDict(rotationVector=rotationalVector, translationVector=translationVector, dict=dict)
        scipy.io.savemat(os.path.join(self.__MAT_DIRECTORY, fileName), dictionary)
        return dictionary
